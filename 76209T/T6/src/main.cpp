...
/*    Module:       main.cpp                                                  */
/*    Author:       mk                                                        */
/*    Created:      Mon May 22 2022                                           */
/*    Description:  Competition for 76209T v6                                 */
/*                                                                            */
/*----------------------------------------------------------------------------*/
...
void pre_auton(void) {
  ...
  Controller1.Screen.print("Initializing."); // this slows 50ms
...
void autonomous(void) {
  ...
  Drivetrain.driveFor(forward, 2700,mm);
